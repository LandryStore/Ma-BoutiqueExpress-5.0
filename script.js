...
// Génération d’un lien Amazon propre si un produit n’a pas de lien direct
...
function renderProducts(list) {
    ...
    pageItems.forEach(p => {
        ...
        // Lien Amazon propre + tag d’affiliation
...
async function loadProducts() {
    ...
    try {
        ...
        console.error(e);
        if (grid) grid.innerHTML = '<div style="text-align:center; padding:3rem; color:red;">Erreur de chargement des produits</div>';
